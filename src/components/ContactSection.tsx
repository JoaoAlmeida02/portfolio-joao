...
const ContactSection = () => {
  ...
  const handleContactClick = async () => {
    const email = 'joaogabrielsantosaa@gmail.com';
  ...
  const socialLinks = [
    {
      name: "GitHub",
      href: "https://github.com/JoaoAlmeida02",
    ...
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/in/joão-almeida-421024280",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/joaoalmeida00_?igsh=MXRjOXU3d3FxcGEzYg%3D%3D&utm_source=qr",

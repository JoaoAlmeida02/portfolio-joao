  ...
  const projects = [
    {
      ...
      repoUrl: "https://github.com/JoaoAlmeida02/barberbook"
    },
    {
      name: "TruckService", 
      descriptionKey: "projects.truckservice.description",
      repoUrl: "https://github.com/JoaoAlmeida02/TruckService"
    }
  ];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <Button
            ...
            asChild
          >
            <a href="https://github.com/JoaoAlmeida02" target="_blank" rel="noopener noreferrer">
